...
@app.callback(
    ...
    [Input("lbtest-dropdown", "value"), State("project-dropdown", "value"), State("study-dropdown", "value"), State('analysis-folder-dropdown', 'value')]
)
def update_lbtest_plot(selected_lbtest, selected_project, selected_study, selected_analysis_folder):
    if not selected_project or not selected_study:
        raise PreventUpdate
