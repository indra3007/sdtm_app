...
app.layout = html.Div([
    ...
    html.Div([
        ...
        dcc.Loading(
            id="loading-progress",
            type="default",  # Choose "circle", "dot", or "default" for spinner styles
            children=html.Div(id="loading-output", style={"margin-top": "10px"})
        )
...
def run_checks_and_display_tabs(n_clicks, selected_project, selected_study, selected_analysis_folder):
    ...
    data_path = f"{base_dir}/{selected_project}/{selected_study}/{selected_analysis_folder}/draft1/sdtmdata"
...
def render_tab_content(selected_dataset, selected_project, selected_study, selected_analysis_folder):
    ...
    if selected_dataset == "Full Summary":
        ...
        if dataset_df.empty:
            ...
            filtered_summary = summary_df[
                summary_df["Datasets"].str.split(",", expand=True)[0].str.strip().eq(selected_dataset)
            ]
            ...
            if test_columns:
                        ...
                        dropdown_id = {'type': 'test-dropdown', 'index': selected_dataset}
                        plot_id = {'type': 'test-plot', 'index': selected_dataset}
