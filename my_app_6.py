...
def run_checks_and_display_tabs(n_clicks, selected_project, selected_study, selected_analysis_folder):
    ...
    spec_path = f"{base_dir}/{selected_project}/{selected_study}/{selected_analysis_folder}/draft1/docs/sdtm/{selected_study}_csdtm_dev_sdtm_mapping.xlsx"
    ...
    try:
        ...
        # Add SDTM Specifications as the first tab
        all_tabs = ["SDTM Specifications", "All Dates"] + all_datasets
...
def render_tab_content(selected_tab, selected_project, selected_study, selected_analysis_folder):
    ...
    # Display "Full Summary" if selected
        ...
        if dataset_df.empty:
            ...
            print('testing at top 2', selected_tab)
